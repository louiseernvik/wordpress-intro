...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220209_wordpressintro_5b261a65a2fa92f36172_20220209123820_archive.zip';
	const ARCHIVE_SIZE		 = '52406485';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5b261a6-09123820';
    const SECONDARY_PACKAGE_HASH = '27bdfd6-09123820';
	const VERSION			 = '1.4.4';
